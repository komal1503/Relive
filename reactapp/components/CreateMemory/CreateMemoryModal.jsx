...
export default function Modal() {
  ...
  return (
    <>
      <button
        className="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 absolute bottom-10 right-10"
        type="button"
            ...
            <div className="relative w-auto my-6 mx-auto max-w-6xl">
              ...
              <form
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  <h3 className="text-3xl font-semibold">Enter Your Memory</h3>
                  <button
